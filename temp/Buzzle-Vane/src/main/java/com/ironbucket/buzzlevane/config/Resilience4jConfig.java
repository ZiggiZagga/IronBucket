...
public class Resilience4jConfig {
    ...
    /**
     * Circuit Breaker Configuration for service discovery calls
    ...
    public CircuitBreaker eurekaCircuitBreaker(CircuitBreakerRegistry registry) {
        ...
        return registry.circuitBreaker("eureka", config);
    }
    ...
    public Retry eurekaRetry(RetryRegistry registry) {
        ...
        return registry.retry("eureka-retry", config);
    }
    ...
    public TimeLimiter eurekaTimeLimiter(TimeLimiterRegistry registry) {
        ...
        return registry.timeLimiter("eureka-timeout", config);
    }
}
