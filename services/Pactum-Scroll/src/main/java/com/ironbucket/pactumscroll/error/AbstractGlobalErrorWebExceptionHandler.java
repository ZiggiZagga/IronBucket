...
public abstract class AbstractGlobalErrorWebExceptionHandler implements WebExceptionHandler, Ordered {
    ...
    protected AbstractGlobalErrorWebExceptionHandler(ObjectMapper objectMapper) {
