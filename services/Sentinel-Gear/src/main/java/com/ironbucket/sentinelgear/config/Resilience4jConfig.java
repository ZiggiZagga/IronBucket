...
public class Resilience4jConfig {
    ...
    public CircuitBreaker policyServiceCircuitBreaker(CircuitBreakerRegistry registry) {
        ...
        return registry.circuitBreaker("policy-service", config);
    }
    ...
    public Retry policyServiceRetry(RetryRegistry registry) {
        ...
        return registry.retry("policy-service-retry", config);
    }
    ...
    public TimeLimiter policyServiceTimeLimiter(TimeLimiterRegistry registry) {
        ...
        return registry.timeLimiter("policy-service-timeout", config);
    }
}
