...
E2E_OBS_DOC_FILE="$ROOT_DIR/docs/E2E-OBSERVABILITY-GUIDE.md"
README_FILE="$ROOT_DIR/README.md"
PROOF_SCRIPT="scripts/e2e/prove-phase1-4-complete.sh"
PHASE2_PROOF_SCRIPT="scripts/e2e/prove-phase2-observability.sh"
FIRST_USER_GATE_SCRIPT="scripts/ci/run-first-user-experience-gate.sh"
OBS_INFRA_GATE_SCRIPT="scripts/ci/run-observability-infra-gate.sh"
PHASE14_ARTIFACT="test-results/phase1-4-proof/"
PHASE2_ARTIFACT="test-results/phase2-observability/"
